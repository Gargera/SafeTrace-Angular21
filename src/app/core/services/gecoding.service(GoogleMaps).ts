...
export class GeocodingService {
  /**
   * Reverse geocode: lat/lng -> "الحي، المحافظة، الدولة"
   * Falls back to raw coordinates if Google returns nothing usable.
   */
  ...
  /**
   * Attaches a Places Autocomplete to a text input. Calls onPlace with lat/lng
   * whenever the user picks a suggestion.
   */
  attachAutocomplete(
