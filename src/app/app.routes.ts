    ...
    children: [
      {
        ...
        title: 'الرئيسية',
        loadChildren: () =>
          import('./features/home-support/home-support.routes').then((m) => m.HOME_SUPPORT_ROUTES),
      },
      {
        path: 'about',
        component: About,
